...
class ApiUserRetrieveController(ApiBaseController):
    """
    获取单个用户类
    """
...
class ApiUserCreateController(ApiBaseController):
    """
    新增一个用户类
    """
...
class ApiUserUpdateController(ApiBaseController):
    """
    修改一个用户类
    """
...
class ApiUserDeleteController(ApiBaseController):
    """
    删除一个用户类
    """
