...
class ApiSystemRetrieveController(ApiBaseController):
    """
    获取公司类列表
    """
...
class ApiSystemCreateController(ApiBaseController):
    def __init__(self, application, request, **kwargs):
        super().__init__(application, request, **kwargs)
        self.system_id = self.get_argument("system_id", "")
        self.system_name = self.get_argument("system_name", "")
...
class ApiSystemUpdateController(ApiBaseController):
    def __init__(self, application, request, **kwargs):
        super().__init__(application, request, **kwargs)
        self.system_id = self.get_argument("system_id", "")
        self.system_name = self.get_argument("system_name", "")
...
class ApiSystemDeleteController(ApiBaseController):
    def __init__(self, application, request, **kwargs):
        super().__init__(application, request, **kwargs)
        self.system_id = self.get_argument("system_id", "")
