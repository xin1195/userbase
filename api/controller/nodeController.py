...
class ApiNodeRetrieveController(ApiBaseController):
    """
    获取公司类列表
    """
...
class ApiNodeCreateController(ApiBaseController):
    def __init__(self, application, request, **kwargs):
        super().__init__(application, request, **kwargs)
        self.node_id = self.get_argument("node_id", "")
        self.node_name = self.get_argument("node_name", "")
...
class ApiNodeUpdateController(ApiBaseController):
    def __init__(self, application, request, **kwargs):
        super().__init__(application, request, **kwargs)
        self.node_id = self.get_argument("node_id", "")
        self.node_name = self.get_argument("node_name", "")
...
class ApiNodeDeleteController(ApiBaseController):
    def __init__(self, application, request, **kwargs):
        super().__init__(application, request, **kwargs)
        self.node_id = self.get_argument("node_id", "")
